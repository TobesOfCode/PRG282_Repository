...
{
    // ===== ChartHelper Class: Provides methods to populate charts for hero stats =====
    public static class ChartHelper
    {
        // ===== Method: Populate a column chart showing average scores by rank =====
        public static void PopulateScoreChart(Chart chartScores, List<Hero> heroes)
        {
            ...
            // ===== Create series for average score =====
            ...
            foreach (var group in rankGroups)
            {
                ...
                switch (group.Rank)
                {
                    case "S-Rank": point.Color = Color.Gold; break;
                    case "A-Rank": point.Color = Color.Silver; break;
                    case "B-Rank": point.Color = Color.Peru; break;
                    case "C-Rank": point.Color = Color.Gray; break;
                    default: point.Color = Color.LightGray; break;
                }

                // ===== Label and tooltip =====
                point.Label = group.AvgScore.ToString("F1");
        ...
        // ===== Method: Populate a pie chart showing distribution of heroes by rank =====
        public static void PopulateRankChart(Chart chartRanks, List<Hero> heroes)
        {
            ...
            // ===== Optional: Dock legend to the right =====
